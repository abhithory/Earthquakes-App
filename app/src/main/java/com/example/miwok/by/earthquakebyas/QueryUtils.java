...
import com.example.miwok.by.earthquakebyas.earthquakes;
...
public final class QueryUtils {
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e("erro", "Error response code: " + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
     ...
     */
    public static ArrayList<earthquakes> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject baseJsonReposce = new JSONObject(earthquakeJSON);
            JSONArray earthQuakeArray = baseJsonReposce.getJSONArray("features");
            ...
            for (int i =0; i<earthQuakeArray.length(); i++ ){
                ...
                String urlmain = properties.getString("url");

                earthquakes earthquakes1 = new earthquakes(magnitude,location,time,urlmain);
                earthquakes.add(earthquakes1);
            }
